...
const Footer = () => {
  ...
  // Social media links
  const socialLinks = [
    { icon: Github, href: 'https://github.com/sharonkadari', label: 'GitHub' },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
              ...
              {quickLinks.map((link) => (
                <li key={link.name}>
                  <a
                    ...
                    className="text-slate-600 hover:text-primary-500 transition-colors duration-300 text-sm"
                  >
                    {link.name}
                  </a>
                </li>
            ...
            <div className="flex gap-4 justify-center sm:justify-start">
              {socialLinks.map((social) => (
                <a
                  ...
                  className="w-10 h-10 bg-slate-100 hover:bg-primary-500 hover:text-white rounded-lg flex items-center justify-center text-slate-600 transition-all duration-300"
        ...
        <div className="border-t border-slate-100 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-center sm:text-left">
          <p className="text-slate-600 text-sm flex items-center gap-1">
            © {currentYear} Sharon Kadariya. Made with <Heart className="w-4 h-4 text-red-500 fill-current" /> 
          </p>
